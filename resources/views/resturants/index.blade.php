        ...
        <div class="container-fluid">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-themecolor">{{__('messages.resturants')}}</h3>
                </div>
...
@foreach($resturants as $resturant)
                                        <tr role="row" class="odd">
                                            ...
                                            <td>
                                                <a class="btn btn-info" href="{{route('resturants-show',$resturant->id)}}" >{{__('messages.show')}}</a>
                                                <a class="btn btn-warning" href="{{route('resturants-edit',$resturant->id)}}" >{{__('messages.edit')}}</a>
                                            </td>
                                        </tr>
@endforeach
