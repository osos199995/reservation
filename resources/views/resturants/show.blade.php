        ...
        <div class="container-fluid">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-themecolor">{{$resturant->name}}</h3>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-xlg-3 col-md-5">
                    <div class="card"> <img class="card-img" src="{{asset('uploads/logos/'.$resturant->logo)}}" alt="Card image">
                ...
                <div class="col-lg-8 col-xlg-9 col-md-7">
                    <div class="card">
                        ...
                        <div class="card-body"> <small class="text-muted">{{$resturant->name}} </small>
                            ...
                            @foreach($resturant->Options as $option)
