        ...
        <!-- ============================================================== -->
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title">{{__('messages.cities')}}</h4>
                                ...
                                <table id="example23" class="display nowrap table table-hover table-striped table-bordered dataTable" cellspacing="0" width="100%" role="grid" aria-describedby="example23_info" style="width: 100%;">
                                    ...
                                    @foreach($cities as $city)
                                        <tr role="row" class="odd">
                                            <td>{{$city->Name}}</td>
                                            <td>{{$city->status==0?'Active':'Deactive'}}</td>
                                            @if ($city->status==0)
                                                {!! Form::open(['method'=>'post','route'=>['cities-status',$city],'files'=>true]) !!}
...
{{--                                                    <a class="btn btn-warning" href="{{route('cities-edit',$city->id)}}" >{{__('messages.edit')}}</a>--}}
                                                </td>
