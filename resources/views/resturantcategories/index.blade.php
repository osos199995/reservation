...
{{--            </div>--}}
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title">{{__('messages.Resturant_Categories')}}</h4>
...
{{--                        <span>PDF</span></a><a class="dt-button buttons-print" tabindex="0" aria-controls="example23" href="#"><span>Print</span>--}}
{{--                    </a></div><div id="example23_filter" class="dataTables_filter">--}}
...
{{--                                    </div>--}}
            <table id="example23" class="display nowrap table table-hover table-striped table-bordered dataTable" cellspacing="0" width="100%" role="grid" aria-describedby="example23_info" style="width: 100%;">
                                        ...
                                        <tbody>
                                        @foreach($resturantsCategories as $resturantCategory)
                                            <tr role="row" class="odd">
                                                <td>{{$resturantCategory->name}}</td>
                                                <td>{{$resturantCategory->status==0?'Active':'Deactive'}}</td>
                                                @if ($resturantCategory->status==0)
                                                    {!! Form::open(['method'=>'post','route'=>['resturants-categories-status',$resturantCategory],'files'=>true]) !!}
                                                    <input type="hidden" name="status" value="1">

                                                    <td><button class="btn btn-danger">{{__('messages.Deactive')}}</button></td>
                                                    {!! Form::close() !!}
                                                    @else
                                                    {!! Form::open(['method'=>'post','route'=>['resturants-categories-status',$resturantCategory],'files'=>true]) !!}
